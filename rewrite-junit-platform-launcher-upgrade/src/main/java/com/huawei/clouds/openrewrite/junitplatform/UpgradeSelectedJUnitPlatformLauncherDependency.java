...
public final class UpgradeSelectedJUnitPlatformLauncherDependency extends Recipe {
    static final String GROUP = "org.junit.platform";
    static final String ARTIFACT = "junit-platform-launcher";
    static final Set<String> SOURCE_VERSIONS = Set.of("1.7.2", "1.8.2");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected JUnit Platform Launcher dependencies to 6.0.1";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact org.junit.platform:junit-platform-launcher versions listed by the workbook in owned " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isJUnitPlatformLauncherDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isJUnitPlatformLauncherDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isJUnitPlatformLauncherDependency(dependencyCursor, dependency);
    }
