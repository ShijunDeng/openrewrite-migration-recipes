...
final class OrgJsonSupport {
    static final String GROUP = "org.json";
    static final String ARTIFACT = "json";
    static final String TARGET = "20250107";
    static final Set<String> SOURCES = Set.of("20160810", "20180813", "20190722", "20200518", "20220320", "20230227", "3.11.2");
    ...
    static boolean isOrgJsonDependency(Cursor cursor, Xml.Tag tag) {
