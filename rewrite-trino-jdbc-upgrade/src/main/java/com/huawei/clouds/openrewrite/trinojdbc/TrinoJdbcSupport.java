...
final class TrinoJdbcSupport {
    static final String GROUP = "io.trino";
    static final String ARTIFACT = "trino-jdbc";
    static final String TARGET = "453";
    static final Set<String> SOURCES = Set.of("418");
    ...
    static boolean isTrinoJdbcDependency(Cursor cursor, Xml.Tag tag) {
