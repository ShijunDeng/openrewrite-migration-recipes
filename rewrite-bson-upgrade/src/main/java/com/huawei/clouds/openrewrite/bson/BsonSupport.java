...
final class BsonSupport {
    static final String GROUP = "org.mongodb";
    static final String ARTIFACT = "bson";
    static final String TARGET = "5.4.0";
    static final Set<String> SOURCES = Set.of("3.12.14", "4.7.2");
    ...
    static boolean isBsonDependency(Cursor cursor, Xml.Tag tag) {
