...
public final class UpgradeSelectedAppiumDependency extends Recipe {
    static final String GROUP = "io.appium";
    static final String ARTIFACT = "java-client";
    static final Set<String> SOURCE_VERSIONS = Set.of("7.5.1");
    static final String TARGET = "9.2.3";
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Appium Java Client dependencies to 9.2.3";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact io.appium:java-client versions listed by the workbook in owned " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isAppiumDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isAppiumDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isAppiumDependency(dependencyCursor, dependency);
    }
