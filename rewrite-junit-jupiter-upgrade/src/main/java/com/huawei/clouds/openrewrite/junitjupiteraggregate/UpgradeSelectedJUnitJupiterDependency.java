...
public final class UpgradeSelectedJUnitJupiterDependency extends Recipe {
    static final String GROUP = "org.junit.jupiter";
    static final String ARTIFACT = "junit-jupiter";
    static final Set<String> SOURCE_VERSIONS = Set.of("5.8.2", "5.9.1", "5.9.3");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected JUnit Jupiter aggregate dependencies to 6.0.1";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact org.junit.jupiter:junit-jupiter versions 5.8.2, 5.9.1, and 5.9.3 in " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isJUnitJupiterDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isJUnitJupiterDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isJUnitJupiterDependency(dependencyCursor, dependency);
    }
