...
class MigrateJUnitJupiter6JavaTest implements RewriteTest {
    ...
    @Test
    void migratesNormallyQualifiedNestedOrderer() {
        rewriteRun(java(
                "import org.junit.jupiter.api.*; @TestMethodOrder(MethodOrderer.Alphanumeric.class) class Tests {}",
                "import org.junit.jupiter.api.*; @TestMethodOrder(MethodOrderer.MethodName.class) class Tests {}"));
    }
        ...
        rewriteRun(java(
                ...
                """
                  ...
                  """, source -> source.afterRecipe(after -> {
                    ...
                    assertTrue(typed[0], "The migrated nested type must carry MethodName type metadata");
                })));
    }
