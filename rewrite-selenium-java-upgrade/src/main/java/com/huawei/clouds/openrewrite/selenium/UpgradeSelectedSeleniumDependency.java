...
public final class UpgradeSelectedSeleniumDependency extends Recipe {
    static final String GROUP = "org.seleniumhq.selenium";
    static final String ARTIFACT = "selenium-java";
    static final Set<String> SOURCE_VERSIONS = Set.of("4.8.1");
    static final String TARGET = "4.41.0";
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Selenium Java dependency to 4.41.0";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact org.seleniumhq.selenium:selenium-java:4.8.1 declarations owned by a Maven " +
               "project/profile or root Gradle dependencies block; external owners, variants, and ranges are untouched.";
    }
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isSeleniumDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isSeleniumDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isSeleniumDependency(dependencyCursor, dependency);
    }
