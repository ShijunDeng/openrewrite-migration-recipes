...
public final class UpgradeSelectedTomcatCatalinaDependency extends Recipe {
    static final String GROUP = "org.apache.tomcat";
    static final String ARTIFACT = "tomcat-catalina";
    static final Set<String> SOURCE_VERSIONS = Set.of(
            "10.1.40", "10.1.47", "10.1.48", "10.1.52",
            "9.0.98", "9.0.105", "9.0.115", "9.0.117");
    static final String TARGET = "10.1.56";
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Tomcat Catalina dependencies to 10.1.56";
    }

    @Override
    public String getDescription() {
        return "Upgrade only the eight exact Tomcat 9.0 and 10.1 source versions supplied for remediation " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isTomcatCatalinaDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isTomcatCatalinaDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isTomcatCatalinaDependency(dependencyCursor, dependency);
    }
