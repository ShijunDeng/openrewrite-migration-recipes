...
/** Updates only source releases visible in the supplied migration spreadsheet. */
public final class UpgradeSelectedAngularCommonDependency extends Recipe {
    ...
    public String getDisplayName() {
        return "Upgrade selected @angular/common declarations to 20.3.26";
    }

    @Override
    public String getDescription() {
        return "Updates exact, caret, or tilde scalar @angular/common declarations selected by the migration spreadsheet, " +
               "without changing compound ranges, protocols, variables, central owners, nested metadata, or lockfiles.";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JsonIsoVisitor<ExecutionContext>() {
            ...
            public Json.Member visitMember(Json.Member member, ExecutionContext ctx) {
                ...
                if (!isPackageJson() || !"@angular/common".equals(key(visited)) ||
