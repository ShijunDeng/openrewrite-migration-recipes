...
/** Upgrade only @angular/animations releases explicitly visible in the migration spreadsheet. */
public final class UpgradeSelectedAngularAnimationsDependency extends Recipe {
    ...
    public String getDisplayName() {
        return "Upgrade selected @angular/animations declarations to 20.3.26";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JsonIsoVisitor<ExecutionContext>() {
            ...
            public Json.Member visitMember(Json.Member member, ExecutionContext ctx) {
                ...
                if (!isPackageJson() || !"@angular/animations".equals(key(visited)) ||
