...
public final class UpgradeSelectedSnakeYamlDependency extends Recipe {
    static final String GROUP = "org.yaml";
    static final String ARTIFACT = "snakeyaml";
    static final Set<String> SOURCE_VERSIONS = Set.of("1.24", "1.26", "1.27", "1.28", "1.32", "1.33", "2");
    static final String TARGET = "2.5";
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected SnakeYAML dependencies to 2.5";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact org.yaml:snakeyaml versions listed by the workbook in owned " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isSnakeYamlDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isSnakeYamlDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isSnakeYamlDependency(dependencyCursor, dependency);
    }
