...
public final class UpgradeSelectedFeignHttpClientDependency extends Recipe {
    static final String GROUP = "io.github.openfeign";
    static final String ARTIFACT = "feign-httpclient";
    static final Set<String> SOURCE_VERSIONS = Set.of("10.4.0", "12", "12.1", "12.2", "12.4");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Feign HttpClient dependencies to 13.6";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact io.github.openfeign:feign-httpclient versions listed by the workbook in owned " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isFeignHttpClientDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isFeignHttpClientDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isFeignHttpClientDependency(dependencyCursor, dependency);
    }
