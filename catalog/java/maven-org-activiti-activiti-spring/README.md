# org.activiti:activiti-spring 升级规格
...
| 字段 | 值 |
| --- | --- |
| Catalog 路径 | `catalog/java/maven-org-activiti-activiti-spring` |
| Maven artifactId | `migration-spec-java-maven-org-activiti-activiti-spring` |
| groupId | `com.huawei.clouds.openrewrite` |
| 规范表格标识 | `org.activiti:activiti-spring` |
| Catalog canonical identity | `org.activiti:activiti-spring`（`UNVERIFIED`，只用于避免目录碰撞） |
| 归一语言类 | `java` |
| Excel 原始语言 | `java` |
| 目标版本 | `8.7.0` |
| Excel 迁移边 | 2 |
...
| ---: | ---: | --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| 1759 | 1758 | `org.activiti:activiti-spring` | java | `7.0.0.SR1` | `8.7.0` | 4 | B4_Major单包 | 中 | upgrade-candidate/mark | 跨1个大版本，需查changelog确认breaking API |
| 1760 | 1759 | `org.activiti:activiti-spring` | java | `7.2.0-h1.cbu.mo.r1` | `8.7.0` | 4 | B4_Major单包 | 中 | upgrade-candidate/mark | 跨1个大版本，需查changelog确认breaking API |
