...
public final class UpgradeSelectedJakartaElApiDependency extends Recipe {
    static final String GROUP = "jakarta.el";
    static final String ARTIFACT = "jakarta.el-api";
    static final Set<String> SOURCE_VERSIONS = Set.of("3.0.3", "5.0.1");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Jakarta EL API dependencies to 6.0.1";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact jakarta.el:jakarta.el-api versions listed by the workbook in owned " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isJakartaElApiDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isJakartaElApiDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isJakartaElApiDependency(dependencyCursor, dependency);
    }
