...
public final class UpgradeSelectedJakartaWsRsApiDependency extends Recipe {
    static final String GROUP = "jakarta.ws.rs";
    static final String ARTIFACT = "jakarta.ws.rs-api";
    static final Set<String> SOURCE_VERSIONS = Set.of("2.1.6", "3.0.0", "3.1.0");
    ...
    public String getDisplayName() {
        return "Upgrade workbook-selected Jakarta REST API dependencies to 4.0.0";
    }

    @Override
    public String getDescription() {
        return "Upgrade only exact jakarta.ws.rs:jakarta.ws.rs-api versions 2.1.6, 3.0.0, and 3.1.0 in " +
    ...
    private static Xml.Document migratePom(Xml.Document document, ExecutionContext ctx) {
        ...
        return (Xml.Document) new XmlIsoVisitor<ExecutionContext>() {
            ...
            public Xml.Tag visitTag(Xml.Tag tag, ExecutionContext ec) {
                ...
                if (isJakartaRestDependency(getCursor(), t) && t.getChildValue("version").map(String::trim)
    ...
    static boolean isJakartaRestDependency(Cursor cursor, Xml.Tag tag) {
    ...
    private static boolean targetVersionReference(Cursor cursor, String text) {
        ...
        return dependencyCursor.getValue() instanceof Xml.Tag dependency &&
               isJakartaRestDependency(dependencyCursor, dependency);
    }
