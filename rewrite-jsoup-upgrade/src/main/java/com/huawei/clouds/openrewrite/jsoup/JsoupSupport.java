...
final class JsoupSupport {
    static final String GROUP = "org.jsoup";
    static final String ARTIFACT = "jsoup";
    static final String TARGET = "1.21.1";
    static final Set<String> SOURCES = Set.of("1.14.2", "1.14.3", "1.15.3", "1.15.4", "1.16.1");
    ...
    static boolean isJsoupDependency(Cursor cursor, Xml.Tag tag) {
